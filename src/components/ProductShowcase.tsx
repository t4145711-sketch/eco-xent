      ...
      <div ref={ref} className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-5xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.p
                className="text-[11px] font-body font-medium tracking-[0.3em] uppercase text-gold mb-2"
              ...
              <motion.h3
                className="text-2xl md:text-4xl font-heading font-semibold text-foreground mb-6"
